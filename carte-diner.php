...
<![endif]-->
	...
	<section id="body">
		<div id="linksCards">
			<a href="carte-dejeuner.php" class="animsition-link" data-animsition-out-class="fade-out-left" data-animsition-out-duration="1500">
			...
			<a href="carte-diner.php" class="animsition-link" data-animsition-out-class="fade-out-right" data-animsition-out-duration="1500">
				<img src="img/carte/background-diner-link.png" alt="Venez dîner chez Buena Onda" width="100%" />
			</a>
			<div class="clear"></div>
		</div>
		...
		<div class="animsition" data-animsition-in-class="fade-in-right" data-animsition-in-duration="1500" data-animsition-out-class="fade-out-right" data-animsition-out-duration="800">
			<h1 style="text-align:center;max-width:1200px;margin:20px auto;">
				DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER
				DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER
				DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER
				DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER
				DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER DÎNER
