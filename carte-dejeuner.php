	...
	<section id="body">
		...
		<div class="animsition" data-animsition-in-class="fade-in-right" data-animsition-in-duration="1500" data-animsition-out-class="fade-out-right" data-animsition-out-duration="800">
            ...
            <div id="title-card"> 
                ...
                <h4>C’est  Buena Onda Prony</h4>
                <p>Sur place et à emporter du lundi au vendredi de 12h00 à 14h30</p>
            </div>
               ...
               <div id="bloc-menu-left">
                       ...
                       <div class="menu-type">
                           <h6 class="menu-h6">ACCOMPAGNEMENTS</h6>
                            ...
                            <ul>
                                <li>Salade <span class="menu-price">2,00 €</span></li>
                                <li>Compotée de légumes <span class="menu-price">5,00 €</span></li>
                           </ul>

                       </div>
                   
                       <div class="menu-type">
                           <h6 class="menu-h6">SALADE</h6>
                             
                            <ul>
                                <li>Salade composée autour du quinoa <span class="menu-price">9,50 €</span></li>
                           </ul>
                       ...
                       <div class="menu-type">
                           ...
                           <ul>
                                <li>Eau minérale 50cl <span class="menu-price">2,50 €</span></li>
                                <li>Soda 33cl // Coca, Coca zéro, Minute Maid pomme, Orangina, 7up, Ice Tea <span class="menu-price">2,50 €</span></li>
                                <li>Gota plate (eau argentine) 50cl<span class="menu-important">*</span> <span class="menu-price">4,50 €</span></li>
                                <li>Gota pétillante (eau argentine) 50cl<span class="menu-important">*</span> <span class="menu-price">5,00 €</span></li>
                                <li>Quilmes 34cl<span class="menu-important">*</span> <span class="menu-price">5,00 €</span></li>
                                <li>Café Nespresso®<span class="menu-important">*</span> <span class="menu-price">2,50 €</span></li>
                                <li>Grand café crème Nespresso®<span class="menu-important">*</span> <span class="menu-price">4,00 €</span></li>
                                <li>Thé Kusmi®<span class="menu-important">*</span> <span class="menu-price">4,00 €</span></li>
                                <li>Maté<span class="menu-important">*</span> <span class="menu-price">4,00 €</span></li>
                            </ul>
                           
                            <div class="menu-important">* Hors formules déjeuner.</div>
                       </div>
                ...
                <div id="bloc-menu-right">
                     ...
                     <div class="menu-type">
                        <h6 class="menu-h6">Nos formules déjeuner </h6>
                        <h6 class="menu-important">Formules empanadas
                            <span class="menu-price-b">sur place</span>
                            <span class="menu-price-g">à emporter</span>
                        </h6>
                            <ul>
                                <li><span class="menu-important">Chico</span> 2 empanadas, salade, boisson, dessert
                                    <span class="menu-price-b">11,50 €</span>
                                    <span class="menu-price-g">10,50 €</span>
                                </li>
                                <li><span class="menu-important">Chango</span> 3 empanadas, salade, boisson, dessert 
                                    <span class="menu-price-b">13,50 €</span>
                                    <span class="menu-price-g">12,50 €</span> 
                                </li>
                                <li><span class="menu-important">Gaucho</span> 4 empanadas, salade, boisson, dessert 
                                    <span class="menu-price-b">15,50 €</span>
                                    <span class="menu-price-g">14,50 €</span>
                                </li>
                                <li><span class="menu-important">Degustación</span><br />(2 personnes) 8 empanadas, salades, 2 verres de vin, desserts
                                    <span class="menu-price">34,00 €</span>
                                </li>
                            </ul>
                        </div>
                    
                        <div class="menu-type">
                               <h6 class="menu-h6">Formule salade </h6>
                               <ul>
                                   <li>Salade composée autour du quinoa, boisson, dessert
                                       <span class="menu-price-b">13,50 €</span>
                                       <span class="menu-price-g">12,50 €</span>
                                   </li>
                                </ul>
                                    <div class="menu-important menu-mt20">Dans chaque formule</div>
                                <p>
                                    1€ déduit pour un article non désiré (uniquement pour la vente à emporter sur les menus 
                                    empanadas) <br />
                                </p>
                                <ul>
                                    <li>Suppl. Quilmes 34cl
                                        <span class="menu-price">2,50 €</span>
                                    </li>
                                    <li>Suppl. verre de vin
